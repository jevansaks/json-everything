...
public class OptionalDataKeyword : IJsonSchemaKeyword
{
	...
	private void Evaluator(KeywordEvaluation evaluation, EvaluationContext context)
	{
		...
		var json = JsonSerializer.Serialize(data, DataExtSerializerContext.Default.Options);
		var subschema = JsonSerializer.Deserialize<JsonSchema>(json, DataExtSerializerContext.Default.Options)!;
