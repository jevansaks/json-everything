...
public class GithubTests
{
   ...
   ""data"": {
	...
	public void Issue183_RuleEvaluatesWrong2_Falsy()
	{
		...
		var rule = JsonSerializer.Deserialize<Rule>(jsonRule, LogicSerializerContext.Default.Rule);
	...
	{
		var rule = JsonSerializer.Deserialize<Rule>("{ \"in\" : [ {\"var\": \"item\"}, {\"var\": \"list\"} ] }", LogicSerializerContext.Default.Rule);
	...
	{
		var rule = JsonSerializer.Deserialize<Rule>("{ \"+\" : [ 1, 2 ] }", LogicSerializerContext.Default.Rule);
  ...
  ""=="": [
    ...
    null
		...
		var rule = node.Deserialize<Rule>(LogicSerializerContext.Default.Rule);
